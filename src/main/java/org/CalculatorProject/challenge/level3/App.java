...
import org.CalculatorProject.challenge.level3.exception.CustomExceptionHandler;
    ...
    private static double getValidatedNumber(Scanner scanner, String prompt) {
        while (true) {
            ...
            if (scanner.hasNextDouble()) {
                ...
                if (num < 0) {
                    System.out.println(ErrorMessage.INVALID_NUMBER.getMessage());
                } else {
                    return num;
                }
            } else {
    ...
    private static void confirmAndRemoveResult(Scanner scanner, ArithmeticCalculator<Double> calculator) {
        while (true) {
            ...
            if (input.equalsIgnoreCase("yes")) {
                ...
                System.out.println(ErrorMessage.INVALID_DELETE_INPUT.getMessage());
            }
        }
    }
    ...
    private static boolean confirmContinue(Scanner scanner) {
        while (true) {
            ...
            if (input.equalsIgnoreCase("exit")) {
                ...
                System.out.println(ErrorMessage.INVALID_CONTINUE_INPUT.getMessage());
            }
        }
    }
}
